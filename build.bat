...
if %errorLevel% == 0 (
    ...
    echo Ayrica CMD'yi Yonetici olarak calistirdiginizdan emin olun.
)
...
if exist fix_encoding.py del fix_encoding.py >nul 2>&1
if exist RCa* del RCa* >nul 2>&1
if exist RCb* del RCb* >nul 2>&1
if exist RCc* del RCc* >nul 2>&1
pause
exit /b 1
